...
public class LogisticDetectionTest extends TestCase implements Serializable {
    ...
    public void testPressure() throws Exception
    {
        ...
        LogisticDetection detector = new LogisticDetection();
        assertFalse(detector.detect(list, "150 1"));
        assertTrue(detector.detect(list, "85 1"));
        assertTrue(detector.detect(list, "142 -1"));
        detector.close();
    }
